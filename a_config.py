...
FORCE_MARGIN:   float = 10        # $ задаем свою мпржу | None - откл
...
TP:             float = 2         # take profit %
TP_TYPE:        int   = 1         # 1 -- limit type, 2 -- market type
BLACK_SET:      set   = {"BRUSDT", "ARIAUSDT", "REIUSDT", "SOPHUSDT", "NTRN", "PARTI"}     # черный список монет. Формат монеты: "BTCUSDT" и т.д.
